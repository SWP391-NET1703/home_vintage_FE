        ...
        <div className="flex flex-col md:gap-10 gap-[149px] items-center justify-center w-full">
          <div className="flex md:flex-col flex-row md:gap-10 items-start justify-between w-full">
            <div className="flex flex-col gap-4 items-start justify-start w-auto">
              ...
              >
                 Ở đây chúng tôi có đầy đủ các loại nội thất từ gia đình cho đến văn phòng, nếu bạn có nhu cầu hãy đến với chúng tôi có đội ngũ nhân viên tư vấn cho mọi người có một không gian phù hợp và theo sở thích nhất
              </Text>
            </div>
          ...
          <div className="flex sm:flex-col flex-row md:gap-10 items-start justify-between w-full">
            ...
            >
              © Copyright 2024. All Rights Reserved. Made by member PiedTeam.
            </Text>
